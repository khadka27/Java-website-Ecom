	...
	<div class=" bg-white border border-4 rounded-lg shadow relative m-10">
		...
		<div class="flex items-start justify-between p-5 border-b rounded-t">
			...
			<button type="button"
				...
				<svg onclick="back()" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
				...
				<div class="grid grid-cols-6 gap-6">
					<div class="col-span-6 sm:col-span-3">
						<label for="product-name"
							...
							Name</label> <input type="text" name="productName" id="product-name"
					...
					<div class="col-span-6 sm:col-span-3">
						<label for="image-file"
							...
							Upload</label> <input type="file" name="imageUrl" id="image-file"
							accept="image/*"
							class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
							required="">
					</div>
					...
					<div class="col-span-6 sm:col-span-3">
						<label for="stock"
							class="text-sm font-medium text-gray-900 block mb-2">Stock</label>
