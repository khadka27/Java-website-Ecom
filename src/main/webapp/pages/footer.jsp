  ...
  <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div class="sm:col-span-2">
      ...
      <div class="mt-6 lg:max-w-sm">
        <p class="text-sm text-gray-800">
          Kyube Gadget: Your one-stop shop for cutting-edge electronics. Explore our range of top-quality gadgets and devices. Shop now for the latest in tech innovation!
        </p>
    ...
    <div class="space-y-2 text-sm">
      ...
      <div class="flex">
        ...
        <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">kyubegadget@gmail.com</a>
      </div>
      <div class="flex">
        ...
        <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
          Sarweshwor Marg, Pokhara 4 33700
        </a>
      </div>
    </div>
    <div>
      ...
      <p class="mt-4 text-sm text-gray-500">
        Follow us on different social media to keep up with our daily updates
      </p>
    </div>
  </div>
